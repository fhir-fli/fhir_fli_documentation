...
| Draft as of 2026-09-06 | *Computable Name*:InadvertentAdministrationStatus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cicada.ig|current/StructureDefinition/StructureDefinition-inadvertent-administration-status.json)
