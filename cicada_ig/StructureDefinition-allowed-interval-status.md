...
| Draft as of 2026-09-06 | *Computable Name*:AllowedIntervalStatus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cicada.ig|current/StructureDefinition/StructureDefinition-allowed-interval-status.json)
