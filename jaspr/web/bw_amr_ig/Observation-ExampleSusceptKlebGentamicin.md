# Klebsiella Susceptibility - Gentamicin (S) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Klebsiella Susceptibility - Gentamicin (S)**

## Example Observation: Klebsiella Susceptibility - Gentamicin (S)
...
```json
{
  ...
  "id" : "ExampleSusceptKlebGentamicin",
  "meta" : {
    "profile" : [
