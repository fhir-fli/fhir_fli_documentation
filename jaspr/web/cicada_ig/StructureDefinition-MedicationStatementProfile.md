...
| Draft as of 2026-09-07 | *Computable Name*:MedicationStatementProfile |
...
* Examples for this Profile: [MedicationStatement/medication-statement-hepb](MedicationStatement-medication-statement-hepb.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cicada.ig|current/StructureDefinition/StructureDefinition-MedicationStatementProfile.json)
