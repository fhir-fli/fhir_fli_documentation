...
| Draft as of 2026-09-07 | *Computable Name*:PreferredVaccineStatus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cicada.ig|current/StructureDefinition/StructureDefinition-preferred-vaccine-status.json)
