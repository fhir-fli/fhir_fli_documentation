...
* Examples for this Profile: [MedicationAdministration/medication-administration-hepb](MedicationAdministration-medication-administration-hepb.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cicada.ig|current/StructureDefinition/StructureDefinition-MedicationAdministrationProfile.json)
