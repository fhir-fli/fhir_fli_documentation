# E. coli Susceptibility - Ampicillin (R) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **E. coli Susceptibility - Ampicillin (R)**

## Example Observation: E. coli Susceptibility - Ampicillin (R)
...
```json
{
  ...
  "id" : "ExampleSusceptEcoliAmpicillin",
  "meta" : {
    "profile" : [
