# Klebsiella Susceptibility - Ampicillin (R) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Klebsiella Susceptibility - Ampicillin (R)**

## Example Observation: Klebsiella Susceptibility - Ampicillin (R)
...
```json
{
  ...
  "id" : "ExampleSusceptKlebAmpicillin",
  "meta" : {
    "profile" : [
