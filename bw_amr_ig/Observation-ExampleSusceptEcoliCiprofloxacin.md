# E. coli Susceptibility - Ciprofloxacin (R) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **E. coli Susceptibility - Ciprofloxacin (R)**

## Example Observation: E. coli Susceptibility - Ciprofloxacin (R)
...
```json
{
  ...
  "id" : "ExampleSusceptEcoliCiprofloxacin",
  "meta" : {
    "profile" : [
