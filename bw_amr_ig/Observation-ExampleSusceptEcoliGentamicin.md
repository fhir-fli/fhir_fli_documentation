# E. coli Susceptibility - Gentamicin (S) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **E. coli Susceptibility - Gentamicin (S)**

## Example Observation: E. coli Susceptibility - Gentamicin (S)
...
```json
{
  ...
  "id" : "ExampleSusceptEcoliGentamicin",
  "meta" : {
    "profile" : [
