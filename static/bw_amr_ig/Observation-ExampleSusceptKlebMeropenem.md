# Klebsiella Susceptibility - Meropenem (S) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Klebsiella Susceptibility - Meropenem (S)**

## Example Observation: Klebsiella Susceptibility - Meropenem (S)
...
**code**: Meropenem [Susceptibility] by Minimum inhibitory concentration (MIC)
...
```json
{
  ...
  "id" : "ExampleSusceptKlebMeropenem",
  "meta" : {
    "profile" : [
