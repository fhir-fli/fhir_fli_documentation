# Klebsiella Susceptibility - Ceftriaxone (S) - Botswana AMR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Klebsiella Susceptibility - Ceftriaxone (S)**

## Example Observation: Klebsiella Susceptibility - Ceftriaxone (S)
...
```json
{
  ...
  "id" : "ExampleSusceptKlebCeftriaxone",
  "meta" : {
    "profile" : [
